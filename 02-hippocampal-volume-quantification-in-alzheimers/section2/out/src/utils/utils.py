...
def med_reshape(image, new_shape):
    ...
    # DONE: write your original image into the reshaped image
    # Write your original image into the reshaped image
    for i in range(image.shape[0]):
        reshaped_image[i,0:image.shape[1],0:image.shape[2]] = image[i,:,:]
    # print(f"med_reshape = {image.shape} to {new_shape}")        
