...
class UNetExperiment:
    ...
    def __init__(self, config, split, dataset):
        ...
        # Create data loaders
        # DONE: SlicesDataset class is not complete. Go to the file and complete it. 
    ...
    def train(self):
        ...
        for i, batch in enumerate(self.train_loader):
            ...
            # print(f"Train batch image = {batch['image'].shape}, seg = {batch['seg'].shape}")
            ...
            # print(f"Prediction = {prediction.shape} Target = {target[:, 0, :, :].shape}")
            # DONE: What does each dimension of variable prediction represent?
            # ANSWER: prediction has shape [8, 3, 64, 64].
            # 0th dimension (ie, 8) is batch size
            # 1st dimension (ie, 3) is channel size, 1 channel for output class
            # 2nd and 3rd dimension (ie, 64 x 64) is image or patch size of each slice
    ...
    def run_test(self):
        ...
        # DONE: Inference Agent is not complete. Go and finish it. Feel free to test the class
